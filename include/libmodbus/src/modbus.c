...
// < ------------------------------ AES --------------------------------> //
                                                                          //
// 128 bit key_aes                                                        //
static const unsigned char key_aes[16] = "key_aes";                                //
                                                                          //
void aes_encrpt( const unsigned char* plain, unsigned char* cipher )     //
{                                                                         //
    AES_KEY aes_key;                                                      //
    ...
    AES_encrypt( plain, cipher, &aes_key );                               //
                                                                          ...
                                                                          //
void aes_decrpt( const unsigned char* cipher, unsigned char* plain )                        //
{                                                                         //
    AES_KEY aes_key;                                                      //
...
int modbus_write_registers(modbus_t *ctx, int addr, int nb, const uint16_t *src)
{
    ...
    aes_encrpt( (const unsigned char*)src, cipher );
    nb = 16;
    ...
    for (i = 0; i < nb; i++) {
        req[req_length++] = cipher[i] >> 8;
        req[req_length++] = cipher[i] & 0x00FF;
    }
